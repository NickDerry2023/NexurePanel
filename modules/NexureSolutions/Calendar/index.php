<?php
    ...
    $eventsDefinitionW = new \NexureSolutions\Calendar\CalendarComponents();
    $eventsDefinitionW->eventsRetrive($con, $accountnumber);

?>

<link href="/modules/NexureSolutions/Calendar/assets/css/main.css" rel="stylesheet" />
<script src="https://demos.codexworld.com/includes/js/jquery.min.js"></script>
<script src="/modules/NexureSolutions/Calendar/assets/js/app.js"></script>
<script src="/modules/NexureSolutions/Calendar/assets/js/dialog.js"></script>
