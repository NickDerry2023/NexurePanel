<?php
    ...
    function createSalesPerformanceGraph($theme, $graphType, $sqlQuery) {
        ...
        if ($result->num_rows > 0) {
            ...
            $imagePath = generateImagePath($_SERVER["DOCUMENT_ROOT"].'/modules/NexureSolutions/Utility/graphSQL/barGraphs', $graphType, $theme);
            imagepng($image, $imagePath);
            imagedestroy($image);

            echo '<img src="/modules/NexureSolutions/Utility/graphSQL/barGraphs/' . basename($imagePath) . '?t=' . time() . '" alt="Bar Graph">';
