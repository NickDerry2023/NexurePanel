<?php
    ...
    // Cali Web Design Google OAuth Module
    // Version: 2.0.1
    ...
    // the Cali Web Design Google OAuth Module will allow you to authenicate
    // using your google account into the Cali Panel. This can save time instead
    ...
    if ($authModulesName == "Google OAuth" && $authModulesDepends == "Present") {

        if ($_SESSION['pagetitle'] == "Login Page") {

            // Loads Variables from ENV so that the OAuth link can be built.

            $google_dotenv = Dotenv::createImmutable($_SERVER['DOCUMENT_ROOT'] . "/modules/NexureSolutions/Oauth/google");
            $google_dotenv->load();
            ...
            echo '
                    <a 
                        ...
                        style="
                            ...
                            color:#000;
                        "
                        href="https://accounts.google.com/o/oauth2/auth?client_id=' . $google_client_id . '&redirect_uri=' . urlencode($google_redirect_uri) . '&response_type=code&scope=openid%20email%20profile">
                            ...
                            <div style="margin:0; padding:0;">
                                <span style="margin:0; padding:0;">' . $LANG_LOGIN_GOOGLE_BUTTON . '</span>
                            </div>
                    </a>
                ';
        } else if ($_SESSION['pagetitle'] == "Dashboard") {

            header("location:/modules/NexureSolutions/Oauth/google/callback");
        }
