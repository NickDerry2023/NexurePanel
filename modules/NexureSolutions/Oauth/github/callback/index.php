<?php
    ...
    $github_dotenv = Dotenv::createImmutable($_SERVER['DOCUMENT_ROOT']."/modules/NexureSolutions/Oauth/github");
        ...
        try {
            ...
            if (isset($github_token_data['access_token'])) {
                ...
                curl_setopt($github_user_info_curl, CURLOPT_HTTPHEADER, array(
                    ...
                    'User-Agent: NexureSolutions' // GitHub API requires a User-Agent header
                ));
