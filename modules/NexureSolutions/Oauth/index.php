        ...
        while ($authModulesLookupRow = mysqli_fetch_assoc($authModulesLookupResult)) {
            ...
            switch ($authModulesName) {
                case "Discord OAuth":
                    ...
                    include $_SERVER["DOCUMENT_ROOT"]."/modules/NexureSolutions/Oauth/discord{$pathPrefix}/index.php";
                    break;
                case "GitHub OAuth":
                    $authModulesDepends = "Present";
                    include $_SERVER["DOCUMENT_ROOT"]."/modules/NexureSolutions/Oauth/github{$pathPrefix}/index.php";
                    break;
                case "Google OAuth":
                    $authModulesDepends = "Present";
                    include $_SERVER["DOCUMENT_ROOT"]."/modules/NexureSolutions/Oauth/google{$pathPrefix}/index.php";
                    break;
                case "Okta OAuth":
                    $authModulesDepends = "Present";
                    include $_SERVER["DOCUMENT_ROOT"]."/modules/NexureSolutions/Oauth/okta{$pathPrefix}/index.php";
                    break;
                case "Apple OAuth":
                    $authModulesDepends = "Present";
                    include $_SERVER["DOCUMENT_ROOT"]."/modules/NexureSolutions/Oauth/apple{$pathPrefix}/index.php";
                    break;
            }
        }
    }
