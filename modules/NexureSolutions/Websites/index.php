...
if (strtolower($currentAccount->role->name) == "customer") {
    ...
    $domainName = "NexureSolutionsservices.com";
                        ...
                        <div class="card-header no-margin">
                            <div class="caliweb-grid caliweb-two-grid" style="grid-template-columns: .6fr 1.5fr; grid-row-gap: 0px;">
                                <div class="image-fluid thumb-web-img">
                                    <img src="https://image.thum.io/get/https://NexureSolutionsservices.com" alt="Website Preview" style="width:100%; height:100%;">
                                </div>
                                <div class="website-info-content">
                                    <div class="website-bottom-part">
                                        <div class="caliweb-grid caliweb-four-grid" style="grid-column-gap:20px; grid-row-gap:30px;">
                                            <a href="/modules/NexureSolutions/Websites/siteBuilder" style="text-decoration:none;" class="dark-mode-white">
                                            ...
                                            <a href="/modules/NexureSolutions/Websites/terminal/" style="text-decoration:none;" class="dark-mode-white">
                                                <div class="caliweb-web-manage-btn">
                                                    <p style="font-weight:700; display:flex; align-items:center;">
                                            ...
                                            <a href="/modules/NexureSolutions/Websites/fileManager" style="text-decoration:none;" class="dark-mode-white">
                                                <div class="caliweb-web-manage-btn">
                                                    <p style="font-weight:700; display:flex; align-items:center;">
                                            ...
                                            <a href="/modules/NexureSolutions/Websites/logFiles" style="text-decoration:none;" class="dark-mode-white">
                                                <div class="caliweb-web-manage-btn">
                                                    <p style="font-weight:700; display:flex; align-items:center;">
                                            ...
                                            <a href="/modules/NexureSolutions/Websites/speedTest" style="text-decoration:none;" class="dark-mode-white">
                                                <div class="caliweb-web-manage-btn">
                                                    <p style="font-weight:700; display:flex; align-items:center;">
                                            ...
                                            <a href="/modules/NexureSolutions/Websites/backupServices" style="text-decoration:none;" class="dark-mode-white">
                                                <div class="caliweb-web-manage-btn">
                                                    <p style="font-weight:700; display:flex; align-items:center;">
                                            ...
                                            <a href="/modules/NexureSolutions/Websites/cloudflareSync" style="text-decoration:none;" class="dark-mode-white">
                                                <div class="caliweb-web-manage-btn">
                                                    <p style="font-weight:700; display:flex; align-items:center;">
                                            ...
                                            <a href="/modules/NexureSolutions/Websites/sslTLSSecurity" style="text-decoration:none;" class="dark-mode-white">
                                                <div class="caliweb-web-manage-btn">
                                                    <p style="font-weight:700; display:flex; align-items:center;">
                                            ...
                                            <a href="/modules/NexureSolutions/Websites/monitoringServices" style="text-decoration:none;" class="dark-mode-white">
                                                <div class="caliweb-web-manage-btn">
                                                    <p style="font-weight:700; display:flex; align-items:center;">
                                            ...
                                            <a href="/modules/NexureSolutions/Websites/gitHub" style="text-decoration:none;" class="dark-mode-white">
                                                <div class="caliweb-web-manage-btn">
                                                    <p style="font-weight:700; display:flex; align-items:center;">
    ...
    <section class="section first-dashboard-area-cards" style="padding-top:2%;">
        <div class="container width-98">
            <div class="caliweb-one-grid special-caliweb-spacing">
                <?php include($_SERVER["DOCUMENT_ROOT"] . '/modules/NexureSolutions/Websites/Backend/Headers/index.php'); ?>
                <div class="caliweb-two-grid special-caliweb-spacing account-grid-modified">
                    <div>
                        ...
                        <div class="caliweb-card dashboard-card" style="margin-top:1%;">
                            <?php include($_SERVER["DOCUMENT_ROOT"] . '/modules/NexureSolutions/Websites/Backend/Menus/index.php'); ?>
                            <div class="website-info-content">
                                <div class="website-bottom-part">
