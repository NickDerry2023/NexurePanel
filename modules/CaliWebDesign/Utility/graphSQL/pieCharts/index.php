<?php
    ...
    if ($_SESSION['graphCallType'] == "Deals by Segment") {
        ...
        if ($result->num_rows > 0) {
            ...
            $imagePath = $_SERVER["DOCUMENT_ROOT"].'/modules/CaliWebDesign/Utility/graphSQL/pieCharts/' . $uniqueFilename;

            imagepng($image, $imagePath);
            imagedestroy($image);

            echo '<img src="/modules/CaliWebDesign/Utility/graphSQL/pieCharts/' . $uniqueFilename . '?t=' . time() . '" alt="Doughnut Chart">';
