<?php
    ...
    echo '<section class="section" style="padding-top:5%; padding-left:5%;">
            <div class="container caliweb-container">
                <h3 class="caliweb-login-heading license-text-dark">'.$LANG_RATELIMIT_ERROR_TITLE_PAR_1.' <span style="font-weight:700;">'.$LANG_RATELIMIT_ERROR_TITLE_PAR_2.'</span></h3>
                <p class="caliweb-login-sublink license-text-dark" style="font-weight:700; padding-top:0; margin-top:0;">'.$LANG_RATELIMIT_ERROR_TITLE.'</p>
                <p class="caliweb-login-sublink license-text-dark width-50">'.$LANG_RATELIMIT_ERROR_TEXT.'</p>
            </div>
        </section>';
