<?php
    ...
    if ($customerAccountInfo != NULL) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $amount = filter_input(INPUT_POST, 'balance', FILTER_VALIDATE_FLOAT);

            $message = updateCreditBalance($manageAccountDefinitionR->customerStripeID, $amount);
                                ...
                                <div class="display-flex align-center" style="justify-content: space-between;">
                                    <div class="display-flex align-center">
                                        <div class="no-padding margin-10px-right icon-size-formatted">
                                            <img src="/assets/img/systemIcons/balance.png" alt="Alter Balance Icon" style="background-color:#f5e6fe;" class="client-business-andor-profile-logo" />
                                        </div>
                                        <div>
                                            <p class="no-padding font-14px">Accounts</p>
                                            <h4 class="text-bold font-size-20 no-padding" style="padding-bottom:0px; padding-top:5px;">Alter Balance</h4>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <a href="/dashboard/administration/accounts/alterBalance/?account_number=<?php echo $accountnumber; ?>" class="caliweb-button secondary no-margin margin-10px-right" style="padding:6px 24px;">Clear Form</a>
                            ...
                            <div class="card-body">
                                <div class="fillable-section-holder" style="margin-top:-3% !important;">
                                    <div class="fillable-header">
                                        <p class="fillable-text">Balance Information</p>
                                    </div>
